          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="https://chat.whatsapp.com/LZWwynFIE148HJiz3Zg0DD" target="_blank" rel="noopener noreferrer" className="btn-primary text-sm py-2">Bergabung</Link>
              </div>
            )}
          </div>
          ...
          <div className="md:hidden mt-4 pb-4 border-t border-gray-100 dark:border-dark-600 pt-4 space-y-1 animate-fade-in">
            ...
            {user ? (
              ...
              <div className="flex gap-2 px-2 pt-2">
                ...
                <Link href="https://chat.whatsapp.com/LZWwynFIE148HJiz3Zg0DD" target="_blank" rel="noopener noreferrer" className="btn-primary flex-1 justify-center text-sm" onClick={() => setMenuOpen(false)}>Bergabung</Link>
              </div>
            )}
          </div>
        )}
