    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="absolute top-1/4 -left-20 w-72 h-72 bg-blue-400/10 rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-600/10 rounded-full blur-3xl animate-pulse-slow animate-delay-300" />
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              {[
                ...
                <div key={stat.label} className="text-center group">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    ...
                    <div className="font-display font-bold text-2xl sm:text-3xl text-blue-600 dark:text-blue-400">
                      {stat.value}
                    </div>
                  </div>
            ...
            {/* Scroll hint */}
            <div className="mt-20 flex flex-col items-center gap-2 animate-fade-up animate-delay-500">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex gap-6 flex-wrap justify-center">
              {[
                ...
                <span
                  key={tech}
                  className="px-4 py-2 bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-600 rounded-xl text-sm font-semibold text-gray-600 dark:text-gray-300 shadow-sm hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all cursor-default"
                >
                  {tech}
                </span>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="badge bg-blue-50 dark:bg-blue-500/10 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/20 mb-4">
                <Sparkles className="w-3.5 h-3.5 mr-1" /> Apa yang Kami Tawarkan
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="card p-6 group hover:border-blue-200 dark:hover:border-blue-500/30 hover:-translate-y-1"
                >
                  <div
        ...
        <section className="py-24 bg-gray-50 dark:bg-dark-800/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
                Bergabung dan mulai perjalananmu bersama CodeIn — cepat, mudah.
              </p>
            </div>
              ...
              {howItWorks.map((item, idx) => (
                <div key={item.step} className="relative text-center group">
                  ...
                  <div className="relative z-10">
                    <div className="w-20 h-20 mx-auto mb-4 bg-white dark:bg-dark-800 border-2 border-blue-100 dark:border-blue-500/20 rounded-2xl flex items-center justify-center shadow-lg group-hover:border-blue-400 group-hover:shadow-blue-500/10 transition-all">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="relative w-full aspect-square max-w-md mx-auto">
                  ...
                  <div className="absolute inset-4 bg-white dark:bg-dark-800 rounded-2xl shadow-xl flex flex-col items-center justify-center p-8 gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full">
                      {[
                        ...
                        <div
                          key={name}
                          className="flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-500/10 rounded-lg"
                        >
                  ...
                  <div className="absolute -top-6 -right-6 bg-white dark:bg-dark-800 border border-gray-100 dark:border-dark-600 rounded-2xl shadow-xl p-3 flex items-center gap-2">
                    <Trophy className="w-5 h-5 text-yellow-500" />
                    <span className="text-xs font-bold text-gray-700 dark:text-gray-200">
                      Community
                    </span>
                  </div>
                  <div className="absolute -bottom-6 -left-6 bg-white dark:bg-dark-800 border border-gray-100 dark:border-dark-600 rounded-2xl shadow-xl p-3 flex items-center gap-2">
                  ...
                  <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-blue-600/10 rounded-full blur-2xl" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600 dark:text-gray-400 text-base leading-relaxed">
                  <p>
                    ...
                    belajar dan berdiskusi di bidang IT. Sistem pembelajaran di
                    kelas yang disamaratakan sering kali tidak mengakomodasi
                    perbedaan tingkat pemahaman setiap individu.
                  </p>
                  <p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((v) => (
                <div
                  key={v.title}
                  className="card p-6 text-center group hover:-translate-y-1 hover:border-blue-200 dark:hover:border-blue-500/30"
                >
                  <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display font-bold text-3xl sm:text-4xl text-gray-900 dark:text-white mb-4">
                Cerita dari <span className="text-gradient">Anggota Kami</span>
              </h2>
              <p className="text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((t) => (
                <div
                  key={t.name}
                  className="card p-6 flex flex-col hover:-translate-y-1 hover:border-blue-200 dark:hover:border-blue-500/30"
                >
